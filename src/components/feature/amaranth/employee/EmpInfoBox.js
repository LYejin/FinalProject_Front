...
import { FaRegListAlt, FaRegCalendarAlt, FaSitemap } from 'react-icons/fa';
    ...
    <div className="selectListWrapper">
      <table className="tableStyle">
        <tbody>
          ...
          <tr>
            <th className="headerCellStyle">회사/부서</th>
            <td colSpan="3" className="cellStyle">
